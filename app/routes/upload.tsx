...
const upload = () => {
   ...
   const navigate = useNavigate();
    ...
    const handleAnalyze = async ({companyName, jobTitle, jobDescription, file}:{companyName:string, jobTitle:string, jobDescription:string, file:File}) => {
        ...
        if(!uploadedFile ) return setStatusText('Error: faailed to upload file');
        ...
        if(!feedback) return setStatusText('Error: failed to get AI feedback');
            ...
            {!isProcessing && (
                <form id="upload-form" onSubmit={handleSubmit} className='flex flex-col gap-4 mt-8'>
                    <div className="form-div">
                        <label htmlFor="company-for">Company Name</label>
                   ...
                   <div className="form-div">
                    ...
                    <div className="form-div">
                        ...
                        <textarea rows={5} name="job-description" id="company-name" placeholder='Job Description' />
                    </div>
